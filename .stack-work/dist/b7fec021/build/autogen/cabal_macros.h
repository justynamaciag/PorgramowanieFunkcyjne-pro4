...
/* package pro4-0.1.0.0 */
#define VERSION_pro4 "0.1.0.0"
#define MIN_VERSION_pro4(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "pro4-0.1.0.0-Br0LB7MXhy4GcpS3yj21Bg"

#define CURRENT_PACKAGE_KEY "pro4-0.1.0.0-Br0LB7MXhy4GcpS3yj21Bg"
